...
bot.on("message", async message =>{
    ...
    if(message.content.startsWith(prefix) && (message.channel.name === "│『📠』ᴄᴏᴍᴍᴀɴᴅᴇs" || message.channel.parent.name !== "MENU RP" || message.channel.parent.name !== "INFORMATIONS VILLE")){
