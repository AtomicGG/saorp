...
bot.on('message', message => {
  if (message.content === (prefix) + "Plaines quêtes"){
    ...
    const Bandit = (Math.floor((3)*Math.random()+2))
    const Lapin = (Math.floor((2*0.75)*Math.random()+2))
      const embed = new Discord.RichEmbed()
      .setColor(3447003)
      .setAuthor(message.author.username , message.author.avatarURL)
      .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
...
bot.on('message', message => {
  ...
  const F = (Math.floor((20)*Math.random()+10))
  const G = (Math.floor((20)*Math.random()+10))
...
bot.on('message', message => {
  if (message.content === (prefix) + "Plaines"){
    ...
    .addField("Pour chasser, niveau 1 minimum requis dans la spécialisation 'Chasseur' :", "=Plaines chasse")
...
//////////////////////////////////////////////////////////Forêt/////////////////////////////////////////////////////////////////////////////////////
 ...
 bot.on('message', message => {
                                                if (message.content === (prefix) + "Forêt"){
                                                  ...
                                                  .addField("Pour chasser, niveau 2 minimum requis dans la spécialisation 'Chasseur' :", "=Forêt chasse")
      ...
      bot.on('message', message => {
        ...
        if (message.content.startsWith(prefix + "Achat/fabrication du casque en peau arraché")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
             .setColor(3447003)
             .addField("Casque en peau arraché :" , "Vous venez d'acheter ou de fabriquer cet objet !")
             .addField("HP :" , +HP)
      ...
      bot.on('message', message => {
        if (message.content.startsWith(prefix + "Casque en peau résistante")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             ...
             .addField("Prix d'achat :" , "300 cols")
          ...
          bot.on('message', message => {
            ...
            if (message.content.startsWith(prefix + "Achat/fabrication du casque en peau résistante")) {
              ...
              .setAuthor(message.author.username , message.author.avatarURL)
                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                 .setColor(3447003)
                 .addField("Casque en peau résistante :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                 .addField("HP :" , +HP)
                 .addField("Points d'armure :" , +Défense)
                  .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                  .setTimestamp()
      ...
      bot.on('message', message => {
        ...
        if (message.content.startsWith(prefix + "Achat/fabrication des épaulières en peau arraché")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
             .setColor(3447003)
             .addField("Epaulières en peau arraché :" , "Vous venez d'acheter ou de fabriquer cet objet !")
             .addField("HP :" , +HP)
             .addField("Points d'armure :" , +Défense)
              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
              .setTimestamp()
              ...
              bot.on('message', message => {
                ...
                if (message.content.startsWith(prefix + "Achat/fabrication des épaulières en peau résistante")) {
                  ...
                  .setAuthor(message.author.username , message.author.avatarURL)
                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                     .setColor(3447003)
                     .addField("Epaulières en peau résistante :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                     .addField("HP :" , +HP)
                     .addField("Points d'armure :" , +Défense)
                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                      .setTimestamp()
      ...
      bot.on('message', message => {
        ...
        if (message.content.startsWith(prefix + "Achat/fabrication de la cape en peau arraché")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
             .setColor(3447003)
             .addField("Cape en peau arraché :" , "Vous venez d'acheter ou de fabriquer cet objet !")
             .addField("HP :" , +HP)
             .addField("Points d'armure :" , +Défense)
              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
              .setTimestamp()
                  ...
                  bot.on('message', message => {
                    ...
                    if (message.content.startsWith(prefix + "Achat/fabrication de la cape en peau résistante")) {
                      ...
                      .setAuthor(message.author.username , message.author.avatarURL)
                         .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                         .setColor(3447003)
                         .addField("Cape en peau résistante :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                         .addField("HP :" , +HP)
                         .addField("Points d'armure :" , +Défense)
                          .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                          .setTimestamp()
      ...
      bot.on('message', message => {
        ...
        if (message.content.startsWith(prefix + "Achat/fabrication du plastron en peau arraché")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
             .setColor(3447003)
             .addField("Plastron en peau arraché :" , "Vous venez d'acheter ou de fabriquer cet objet !")
             .addField("HP :" , +HP)
             .addField("Points d'armure :" , +Défense)
              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
              .setTimestamp()
                      ...
                      bot.on('message', message => {
                        ...
                        if (message.content.startsWith(prefix + "Achat/fabrication du plastron en peau résistante")) {
                          ...
                          .setAuthor(message.author.username , message.author.avatarURL)
                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                             .setColor(3447003)
                             .addField("Plastron en peau résistante :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                             .addField("HP :" , +HP)
                             .addField("Points d'armure :" , +Défense)
                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                              .setTimestamp()
      ...
      bot.on('message', message => {
        ...
        if (message.content.startsWith(prefix + "Achat/fabrication des gantelets en peau arraché")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
             .setColor(3447003)
             .addField("Gantelets en peau arraché :" , "Vous venez d'acheter ou de fabriquer cet objet !")
             .addField("HP :" , +HP)
             .addField("Points d'armure :" , +Défense)
              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
              .setTimestamp()
                          ...
                          bot.on('message', message => {
                            ...
                            if (message.content.startsWith(prefix + "Achat/fabrication des gantelets en peau résistante")) {
                              ...
                              .setAuthor(message.author.username , message.author.avatarURL)
                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                 .setColor(3447003)
                                 .addField("Gantelets en peau résistante :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                 .addField("HP :" , +HP)
                                 .addField("Points d'armure :" , +Défense)
                                  .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                  .setTimestamp()
      ...
      bot.on('message', message => {
        ...
        if (message.content.startsWith(prefix + "Achat/fabrication de la ceinture en peau arraché")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
             .setColor(3447003)
             .addField("Ceinture en peau arraché :" , "Vous venez d'acheter ou de fabriquer cet objet !")
             .addField("HP :" , +HP)
             .addField("Points d'armure :" , +Défense)
              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
              .setTimestamp()
                              ...
                              bot.on('message', message => {
                                ...
                                if (message.content.startsWith(prefix + "Achat/fabrication de la ceinture en peau résistante")) {
                                  ...
                                  .setAuthor(message.author.username , message.author.avatarURL)
                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                     .setColor(3447003)
                                     .addField("Ceinture en peau résistante :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                     .addField("HP :" , +HP)
                                     .addField("Points d'armure :" , +Défense)
                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                      .setTimestamp()
      ...
      bot.on('message', message => {
        ...
        if (message.content.startsWith(prefix + "Achat/fabrication des jambières en peau arraché")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
             .setColor(3447003)
             .addField("Jambières en peau arraché :" , "Vous venez d'acheter ou de fabriquer cet objet !")
             .addField("HP :" , +HP)
             .addField("Points d'armure :" , +Défense)
              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
              .setTimestamp()
                                  ...
                                  bot.on('message', message => {
                                    ...
                                    if (message.content.startsWith(prefix + "Achat/fabrication des jambières en peau résistante")) {
                                      ...
                                      .setAuthor(message.author.username , message.author.avatarURL)
                                         .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                         .setColor(3447003)
                                         .addField("Jambières en peau résistante :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                         .addField("HP :" , +HP)
                                         .addField("Points d'armure :" , +Défense)
                                          .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                          .setTimestamp()
      ...
      bot.on('message', message => {
        ...
        if (message.content.startsWith(prefix + "Achat/fabrication des bottes en peau arraché")) {
          ...
          .setAuthor(message.author.username , message.author.avatarURL)
             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
             .setColor(3447003)
             .addField("Bottes en peau arraché :" , "Vous venez d'acheter ou de fabriquer cet objet !")
             .addField("HP :" , +HP)
             .addField("Points d'armure :" , +Défense)
              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
              .setTimestamp()
                                      ...
                                      bot.on('message', message => {
                                        ...
                                        if (message.content.startsWith(prefix + "Achat/fabrication des bottes en peau résistante")) {
                                          ...
                                          .setAuthor(message.author.username , message.author.avatarURL)
                                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                             .setColor(3447003)
                                             .addField("Bottes en peau résistante :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                             .addField("HP :" , +HP)
                                             .addField("Points d'armure :" , +Défense)
                                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                              .setTimestamp()
                                          ...
                                          bot.on('message', message => {
                                            ...
                                            if (message.content.startsWith(prefix + "Achat/fabrication de l'amulette en coeur d'animal faible")) {
                                              ...
                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                 .setColor(3447003)
                                                 .addField("Anneau en coeur d'animal faible :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                 .addField("HP :" , +HP)
                                            ...
                                            const Dégâts = (Math.floor((3)*Math.random()+1))
                                                if (message.content.startsWith(prefix + "Achat/fabrication de l'anneau en coeur d'animal faible")) {
                                                  ...
                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                     .setColor(3447003)
                                                     .addField("Amulette en coeur d'animal faible :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                     .addField("HP :" , +HP)
                                                     .addField("Points de dégâts :" , +Dégâts)
                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                      .setTimestamp()
                                          ...
                                          bot.on('message', message => {
                                            if (message.content.startsWith(prefix + "Amulette du croc")) {
                                              ...
                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                 ...
                                                 .addField("Points d'expérience gagnés dans la spécialisation 'Forgeron' une fois l'objet fabriquer :" , "6")
                                                 .addField("Prix d'achat :" , "600 cols")
                                            ...
                                            const Dégâts = (Math.floor((4)*Math.random()+2))
                                                if (message.content.startsWith(prefix + "Achat/fabrication de l'amulette du croc")) {
                                                  ...
                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                     .setColor(3447003)
                                                     .addField("Amulette du croc :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                     .addField("HP :" , +HP)
                                                     .addField("Points de dégâts :" , +Dégâts)
                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                      .setTimestamp()
                                            ...
                                            const Dégâts = (Math.floor((4)*Math.random()+2))
                                                if (message.content.startsWith(prefix + "Achat/fabrication de l'anneau du croc")) {
                                                  ...
                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                     .setColor(3447003)
                                                     .addField("Anneau du croc :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                     .addField("HP :" , +HP)
                                                     .addField("Points de dégâts :" , +Dégâts)
                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                      .setTimestamp()
                                                ...
                                                const Dégâts = (Math.floor((5)*Math.random()+2))
                                                    if (message.content.startsWith(prefix + "Achat/fabrication de l'épée basique à deux mains")) {
                                                      ...
                                                      .setAuthor(message.author.username , message.author.avatarURL)
                                                         .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                         .setColor(3447003)
                                                         .addField("Epée basique à deux mains :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                         .addField("Points de dégâts :" , +Dégâts)
                                                          .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                          .setTimestamp()
                                                          message.channel.send({embed})
                                                  ...
                                                  bot.on('message', message => {
                                                    if (message.content.startsWith(prefix + "Epée basique à une main")) {
                                                     ...
                                                     .addField("Prix d'achat :" , "150 cols")
                                                        ...
                                                        const Dégâts = (Math.floor((3)*Math.random()+1))
                                                            if (message.content.startsWith(prefix + "Achat/fabrication de l'épée basique à une main")) {
                                                              ...
                                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                 .setColor(3447003)
                                                                 .addField("Epée basique à une main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                 .addField("Points de dégâts :" , +Dégâts)
                                                                  .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                  .setTimestamp()
                                                                  message.channel.send({embed})
                                                        ...
                                                        const Dégâts = (Math.floor((5)*Math.random()+2))
                                                            if (message.content.startsWith(prefix + "Achat/fabrication de la masse basique à deux mains")) {
                                                              ...
                                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                 .setColor(3447003)
                                                                 .addField("Masse basique à deux mains :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                 .addField("Points de dégâts :" , +Dégâts)
                                                                  .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                  .setTimestamp()
                                                                  message.channel.send({embed})
                                                            ...
                                                            const Dégâts = (Math.floor((3)*Math.random()+1))
                                                                if (message.content.startsWith(prefix + "Achat/fabrication de la masse basique à une main")) {
                                                                  ...
                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                     .setColor(3447003)
                                                                     .addField("Masse basique à une main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                     .addField("Points de dégâts :" , +Dégâts)
                                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                      .setTimestamp()
                                                                      message.channel.send({embed})
                                                            ...
                                                            const Dégâts = (Math.floor((5)*Math.random()+2))
                                                                if (message.content.startsWith(prefix + "Achat/fabrication de la hache basique à deux mains")) {
                                                                  ...
                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                     .setColor(3447003)
                                                                     .addField("Hache basique à deux mains :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                     .addField("Points de dégâts :" , +Dégâts)
                                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                      .setTimestamp()
                                                                      message.channel.send({embed})
                                                            ...
                                                            const Dégâts = (Math.floor((3)*Math.random()+1))
                                                                if (message.content.startsWith(prefix + "Achat/fabrication de la hache basique à une main")) {
                                                                  ...
                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                     .setColor(3447003)
                                                                     .addField("Hache basique à une main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                     .addField("Points de dégâts :" , +Dégâts)
                                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                      .setTimestamp()
                                                                      message.channel.send({embed})
                                                                ...
                                                                const Dégâts = (Math.floor((5)*Math.random()+2))
                                                                    if (message.content.startsWith(prefix + "Achat/fabrication de la rapière basique à deux mains")) {
                                                                      ...
                                                                      .setAuthor(message.author.username , message.author.avatarURL)
                                                                         .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                         .setColor(3447003)
                                                                         .addField("Rapière basique à deux mains :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                         .addField("Points de dégâts :" , +Dégâts)
                                                                          .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                          .setTimestamp()
                                                                          message.channel.send({embed})
                                                                    ...
                                                                    const Dégâts = (Math.floor((3)*Math.random()+1))
                                                                        if (message.content.startsWith(prefix + "Achat/fabrication de la rapière basique à une main")) {
                                                                          ...
                                                                          .setAuthor(message.author.username , message.author.avatarURL)
                                                                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                             .setColor(3447003)
                                                                             .addField("Rapière basique à une main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                             .addField("Points de dégâts :" , +Dégâts)
                                                                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                              .setTimestamp()
                                                                              message.channel.send({embed})
                                                                    ...
                                                                    const Dégâts = (Math.floor((5)*Math.random()+2))
                                                                        if (message.content.startsWith(prefix + "Achat/fabrication de la cimeterre basique à deux mains")) {
                                                                          ...
                                                                          .setAuthor(message.author.username , message.author.avatarURL)
                                                                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                             .setColor(3447003)
                                                                             .addField("Cimeterre basique à deux main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                             .addField("Points de dégâts :" , +Dégâts)
                                                                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                              .setTimestamp()
                                                                              message.channel.send({embed})
                                                                    ...
                                                                    const Dégâts = (Math.floor((3)*Math.random()+1))
                                                                        if (message.content.startsWith(prefix + "Achat/fabrication de la cimeterre basique à une main")) {
                                                                          ...
                                                                          .setAuthor(message.author.username , message.author.avatarURL)
                                                                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                             .setColor(3447003)
                                                                             .addField("Cimeterre basique à une main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                             .addField("Points de dégâts :" , +Dégâts)
                                                                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                              .setTimestamp()
                                                                              message.channel.send({embed})
                                                                        ...
                                                                        const Dégâts = (Math.floor((5)*Math.random()+2))
                                                                            if (message.content.startsWith(prefix + "Achat/fabrication du katana basique à deux mains")) {
                                                                              ...
                                                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                 .setColor(3447003)
                                                                                 .addField("Katana basique à deux mains :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                 .addField("Points de dégâts :" , +Dégâts)
                                                                                  .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                  .setTimestamp()
                                                                                  message.channel.send({embed})
                                                                            ...
                                                                            const Dégâts = (Math.floor((3)*Math.random()+1))
                                                                                if (message.content.startsWith(prefix + "Achat/fabrication du katana basique à une main")) {
                                                                                  ...
                                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                     .setColor(3447003)
                                                                                     .addField("Katana basique à une main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                     .addField("Points de dégâts :" , +Dégâts)
                                                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                      .setTimestamp()
                                                                                      message.channel.send({embed})
                                                                            ...
                                                                            const Dégâts = (Math.floor((5)*Math.random()+2))
                                                                                if (message.content.startsWith(prefix + "Achat/fabrication du glaive basique à deux mains")) {
                                                                                  ...
                                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                     .setColor(3447003)
                                                                                     .addField("Glaive basique à deux mains :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                     .addField("Points de dégâts :" , +Dégâts)
                                                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                      .setTimestamp()
                                                                                      message.channel.send({embed})
                                                                                ...
                                                                                const Dégâts = (Math.floor((3)*Math.random()+1))
                                                                                    if (message.content.startsWith(prefix + "Achat/fabrication de la dague basique à une main")) {
                                                                                      ...
                                                                                      .setAuthor(message.author.username , message.author.avatarURL)
                                                                                         .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                         .setColor(3447003)
                                                                                         .addField("Dague basique à une main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                         .addField("Points de dégâts :" , +Dégâts)
                                                                                          .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                          .setTimestamp()
                                                                                          message.channel.send({embed})
                                                                                    ...
                                                                                    const HP = (Math.floor((7)*Math.random()+3))
                                                                                        if (message.content.startsWith(prefix + "Achat/fabrication du bouclier basique à une main")) {
                                                                                          ...
                                                                                          .setAuthor(message.author.username , message.author.avatarURL)
                                                                                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                             .setColor(3447003)
                                                                                             .addField("Bouclier basique à une main :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                             .addField("HP :" , +HP)
                                                                                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                              .setTimestamp()
                                                                                              message.channel.send({embed})
                                                                                  ...
                                                                                  bot.on('message', message => {
                                                                                        if (message.content.startsWith(prefix + "Achat/fabrication du parchemin de poison faible")) {
                                                                                          ...
                                                                                          .setAuthor(message.author.username , message.author.avatarURL)
                                                                                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                             .setColor(3447003)
                                                                                             .addField("Parchemin de poison faible :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                             .addField("Chaque fois que vous infligez des dégâts à un ennemis :" , "=Poison faible")
                                                                                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                              .setTimestamp()
                                                                                              message.channel.send({embed})
                                                                                            }   
                                                                                        ...
                                                                                        const HP = (Math.floor((11)*Math.random()+10))
                                                                                            if (message.content.startsWith(prefix + "Achat/fabrication du ragoût de renard")) {
                                                                                              ...
                                                                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                 .setColor(3447003)
                                                                                                 .addField("Ragoût de renard :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                            ...
                                                                                            const HP = (Math.floor((11)*Math.random()+10))
                                                                                                if (message.content.startsWith(prefix + "Achat/fabrication du ragoût de sanglier")) {
                                                                                                  ...
                                                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                     .setColor(3447003)
                                                                                                     .addField("Ragoût de sanglier :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                     .addField("Lorsque vous utilisez cet objet, vous regagnez des HP :" , +HP)
                                                                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                      .setTimestamp()
                                                                                                      message.channel.send({embed})
                                                                                                ...
                                                                                                const HP = (Math.floor((11)*Math.random()+10))
                                                                                                    if (message.content.startsWith(prefix + "Achat/fabrication du ragoût de chien")) {
                                                                                                      ...
                                                                                                      .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                         .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                         .setColor(3447003)
                                                                                                         .addField("Ragoût de chien :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                         .addField("Lorsque vous utilisez cet objet, vous regagnez des HP :" , +HP)
                                                                                                          .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                          .setTimestamp()
                                                                                                          message.channel.send({embed})
                                                                                                    ...
                                                                                                    const HP = (Math.floor((21)*Math.random()+20))
                                                                                                        if (message.content.startsWith(prefix + "Achat/fabrication du ragoût de lapin géant")) {
                                                                                                          ...
                                                                                                          .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                             .setColor(3447003)
                                                                                                             .addField("Ragoût de lapin géant :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                             .addField("Lorsque vous utilisez cet objet, vous regagnez des HP :" , +HP)
                                                                                                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                              .setTimestamp()
                                                                                                              message.channel.send({embed})
                                                                                                            ...
                                                                                                            const HP = (Math.floor((21)*Math.random()+20))
                                                                                                                if (message.content.startsWith(prefix + "Achat/fabrication du ragoût de loup")) {
                                                                                                                  ...
                                                                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                                     .setColor(3447003)
                                                                                                                     .addField("Ragoût de loup :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                                     .addField("Lorsque vous utilisez cet objet, vous regagnez des HP :" , +HP)
                                                                                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                                      .setTimestamp()
                                                                                                                      message.channel.send({embed})
                                                                                                                ...
                                                                                                                const HP = (Math.floor((41)*Math.random()+40))
                                                                                                                    if (message.content.startsWith(prefix + "Achat/fabrication du ragoût de loup de sang")) {
                                                                                                                      ...
                                                                                                                      .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                                         .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                                         .setColor(3447003)
                                                                                                                         .addField("Ragoût de loup de sang :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                                         .addField("Lorsque vous utilisez cet objet, vous regagnez des HP :" , +HP)
                                                                                                                          .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                                          .setTimestamp()
                                                                                                                          message.channel.send({embed})
                                                                                                                ...
                                                                                                                if (message.content.startsWith(prefix + "Ragoût de taupe")) {
                                                                                                                    ...
                                                                                                                    const HP = (Math.floor((21)*Math.random()+20))
                                                                                                                        if (message.content.startsWith(prefix + "Achat/fabrication du ragoût de taupe")) {
                                                                                                                          ...
                                                                                                                          .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                                             .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                                             .setColor(3447003)
                                                                                                                             .addField("Ragoût de taupe :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                                             .addField("Lorsque vous utilisez cet objet, vous regagnez des HP :" , +HP)
                                                                                                                              .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                                              .setTimestamp()
                                                                                                                              message.channel.send({embed})
                                                                                                                  ...
                                                                                                                  bot.on('message', message => {
                                                                                                                    if (message.content.startsWith(prefix + "Potion faible de force")) {
                                                                                                                     ...
                                                                                                                     .addField("Prix d'achat :" , "100 cols")
                                                                                                                     .addField("Prix de revente :" , "50 cols")
                                                                                                                     .addField("Pour acheter ou fabriquer cet objet :" , "=Achat/fabrication de la potion faible de force")
                                                                                                                         .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                                          .setTimestamp()
                                                                                                                          message.channel.send({embed})
                                                                                                                        }   
                                                                                                                        ...
                                                                                                                        const HP = (Math.floor((3)*Math.random()+2))
                                                                                                                            if (message.content.startsWith(prefix + "Achat/fabrication de la potion faible de force")) {
                                                                                                                              ...
                                                                                                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                                                 .setColor(3447003)
                                                                                                                                 .addField("Potion faible de force :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                                            ...
                                                                                                                            const HP = (Math.floor((2)*Math.random()+1))
                                                                                                                                if (message.content.startsWith(prefix + "Achat/fabrication de la potion faible de défense")) {
                                                                                                                                  ...
                                                                                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                                                     .setColor(3447003)
                                                                                                                                     .addField("Potion faible de défense :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                            ...
                                                                                                            const HP = (Math.floor((41)*Math.random()+60))
                                                                                                                if (message.content.startsWith(prefix + "Achat/fabrication de la potion légère de soin")) {
                                                                                                                  ...
                                                                                                                  .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                                     .setColor(3447003)
                                                                                                                     .addField("Potion légère de soin :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                                     .addField("Lorsque vous utilisez cet objet, vous regagnez des HP :" , +HP)
                                                                                                                      .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                                      .setTimestamp()
                                                                                                                      message.channel.send({embed})
                                                                                                                        ...
                                                                                                                        const HP = (Math.floor((5)*Math.random()+4))
                                                                                                                            if (message.content.startsWith(prefix + "Achat/fabrication de la potion légère de force")) {
                                                                                                                              ...
                                                                                                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                                                 .setColor(3447003)
                                                                                                                                 .addField("Potion légère de force :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                                                 .addField("Lorsque vous utilisez cet objet, pour les 10 prochains coups que vous infligez, vous gagnez des dégâts supplémentaires :" , +HP)
                                                                                                                                  .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                                                  .setTimestamp()
                                                                                                                                  message.channel.send({embed})
                                                                                                                        ...
                                                                                                                        const HP = (Math.floor((3)*Math.random()+2))
                                                                                                                            if (message.content.startsWith(prefix + "Achat/fabrication de la potion légère de défense")) {
                                                                                                                              ...
                                                                                                                              .setAuthor(message.author.username , message.author.avatarURL)
                                                                                                                                 .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                                                                                                 .setColor(3447003)
                                                                                                                                 .addField("Potion légère de défense :" , "Vous venez d'acheter ou de fabriquer cet objet !")
                                                                                                                                 .addField("Lorsque vous utilisez cet objet, pour les 10 prochains coups que vous recevez, vous gagnez de la défense supplémentaire :" , +HP)
                                                                                                                                  .setImage("https://i.pinimg.com/originals/18/fb/4b/18fb4b82ad92387d26413f1ef3518d96.png")
                                                                                                                                  .setTimestamp()
                                                                                                                                  message.channel.send({embed})
...
bot.on('message', message => {
  if (message.content.startsWith(prefix + "Fabriquer le casque en peau arraché")) {
      const HP = (Math.floor((5+(X*3))*Math.random()+3))
      const Dégats = (Math.floor((2+(X*1))*Math.random()+2))
      const Défense = (Math.floor((1+(X/2))*Math.random()+1))
      const Exp = (Math.floor((3)*Math.random()+2))
        const embed = new Discord.RichEmbed()
        .setAuthor(message.author.username , message.author.avatarURL)
        .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
        .setColor(3447003)
        .addField("Bottes en peau arraché :" , "Des bottes déchiré et fragile, mais utile pour les débutants !")
        .addField("HP :" , +HP)
        .addField("Points de dégâts :" , +Dégats)
        .addField("Points de défense :" , +Défense)
        .addField("Temps de création :" , "15 minutes")
        .addField("Maître du cuir :" , "Rapporte " +Exp+ " points d'expérience !")
        .setImage("https://blog.decentm.com/content/images/2018/03/sao-0203.jpg")
        .setTimestamp()
