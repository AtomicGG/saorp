            ...
            bot.on('message', message => {
              ...
              bot.on('message', message => {
                ...
                bot.on('message', message => {
                  ...
                  const K = (Math.floor((2-(0.98))*Math.random()))
                  ...
                  const S = (Math.floor((2-(0.99))*Math.random()))
                     const T = (Math.floor((2-(0.97))*Math.random()))
                      const U = (Math.floor((2-(0.95))*Math.random()))
                      const V = (Math.floor((2-(0.95))*Math.random()))
                      const W = (Math.floor((2-(0.95))*Math.random()))
                      const X = (Math.floor((2-(0.95))*Math.random()))
                       const Y = (Math.floor((2-(0.97))*Math.random()))
                        const Z = (Math.floor((2-(0.97))*Math.random()))
                    const F = (Math.floor((41)*Math.random()+40))
                    const G = (Math.floor((21)*Math.random()+20))
                      const embed = new Discord.RichEmbed()
                      .setColor(3447003)
