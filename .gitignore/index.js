...
bot.on('message', message => {
  ...
  const args = cont.slice(1);
                  ...
                  const J = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const K = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const L = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const M = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const N = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const O = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const P = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const Q = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const R = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                  const S = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                     const T = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                      const U = (Math.floor(((AB*1+1-1)*(0.90))*Math.random()))
                      const V = (Math.floor(((AB*1+1-1)*(0.90))*Math.random()))
                      const W = (Math.floor(((AB*1+1-1)*(0.90))*Math.random()))
                      const X = (Math.floor(((AB*1+1-1)*(0.90))*Math.random()))
                       const Y = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
                        const Z = (Math.floor(((AB*1+1-1)*(0.95))*Math.random()))
