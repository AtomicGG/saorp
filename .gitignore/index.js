  ...
  const args = cont.slice(1);
    ...
    const embed = new Discord.RichEmbed()
     ...
     message.channel.send({embed})
                                              ...
                                              const B = (Math.floor((Z+1)*Math.random()+0))
                                              const C = (Math.floor((Z+1)*Math.random()+0))
                                              const D = (Math.floor((Z+1)*Math.random()+0))
                                              const E = (Math.floor(((Z+1)*(0.80))*Math.random()+0))
                                              const F = (Math.floor(((Z+1)*(0.60))*Math.random()+0))
                                               const embed = new Discord.RichEmbed()
                                               .setAuthor(message.author.username , message.author.avatarURL)
                                               .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                               .setColor(3447003)
  ...
  const args = cont.slice(1);
    ...
    const embed = new Discord.RichEmbed()
     ...
     message.channel.send({embed})
                                                    ...
                                                    const C = (Math.floor((Z+1)*Math.random()+0))
                                                    const D = (Math.floor((Z+1)*Math.random()+0))
                                                    const E = (Math.floor(((Z+1)*(0.60))*Math.random()+0))
                                                    const F = (Math.floor(((Z+1)*(0.80))*Math.random()+0))
                                                     const embed = new Discord.RichEmbed()
                                                     .setAuthor(message.author.username , message.author.avatarURL)
                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                     .setColor(3447003)
