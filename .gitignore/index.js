...
bot.on('message', message => {
  ...
  const F = (Math.floor(((14)*Z)*Math.random()+14))
  const G = (Math.floor(((11)*Z)*Math.random()+10))
  ...
  const args = cont.slice(1);
    ...
    const D = (Math.floor(((2*(0.75))*Z)*Math.random()))
    const E = (Math.floor(((2*(0.85))*Z)*Math.random()))
    const F = (Math.floor(((11)*Z)*Math.random()+10))
    const G = (Math.floor(((6)*Z)*Math.random()+5))
      const embed = new Discord.RichEmbed()
      .setColor(3447003)
      .setAuthor(message.author.username , message.author.avatarURL)
      .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
  ...
  const args = cont.slice(1);
          ...
          const E = (Math.floor(((2*(0.85))*Z)*Math.random()))
          const I = (Math.floor(((2*(0.90))*Z)*Math.random()))
          const F = (Math.floor(((17)*Z)*Math.random()+17))
          const G = (Math.floor(((21)*Z)*Math.random()+20))
            const embed = new Discord.RichEmbed()
            .setColor(3447003)
            .setAuthor(message.author.username , message.author.avatarURL)
            .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
  ...
  const args = cont.slice(1);
            ...
            const B = (Math.floor(((3)*Z)*Math.random()))
            const C = (Math.floor(((3)*Z)*Math.random()))
            const D = (Math.floor(((2*(0.80))*Z)*Math.random()))
            const E = (Math.floor(((2*(0.90))*Z)*Math.random()))
            const I = (Math.floor(((2*(0.95))*Z)*Math.random()))
            const F = (Math.floor(((28)*Z)*Math.random()+28))
            const G = (Math.floor(((21)*Z)*Math.random()+20))
              const embed = new Discord.RichEmbed()
              .setColor(3447003)
              .setAuthor(message.author.username , message.author.avatarURL)
              ...
              .addField("Points d'expérience :" , +F)
              .addField("Si vous êtes du niveau de 15 ou plus :" , "Vous ne gagnez plus d'expérience sur ce monstre")
              .addField("Cols :" , +G)
              .setTimestamp()
              message.channel.send({embed})
                  }
  ...
  const args = cont.slice(1);
                                                if (message.content.startsWith(prefix + "Slime récompenses")) {
                                                  let Z = args.slice(2).join(" : ");
              const B = (Math.floor(((3)*Z)*Math.random()))
              const C = (Math.floor(((2*(0.50))*Z)*Math.random()))
              const F = (Math.floor(((14)*Z)*Math.random()+14))
              const G = (Math.floor(((11)*Z)*Math.random()+10))
              const H = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const I = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const J = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const K = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const L = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const M = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const N = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const O = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const P = (Math.floor(((2*(0.95))*Z)*Math.random()))
              const Q = (Math.floor(((2*(0.95))*Z)*Math.random()))
                const embed = new Discord.RichEmbed()
                .setColor(3447003)
                .setAuthor(message.author.username , message.author.avatarURL)
                .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
  ...
  const args = cont.slice(1);
                  ...
                  const P = (Math.floor(((2*(0.95))*Z)*Math.random()))
                  const Q = (Math.floor(((2*(0.95))*Z)*Math.random()))
                   const R = (Math.floor(((2*(0.95))*Z)*Math.random()))
                    const S = (Math.floor(((2*(0.95))*Z)*Math.random()))
                     const T = (Math.floor(((2*(0.90))*Z)*Math.random()))
                      const U = (Math.floor(((2*(0.90))*Z)*Math.random()))
                      const V = (Math.floor(((2*(0.90))*Z)*Math.random()))
                const F = (Math.floor(((11)*Z)*Math.random()+10))
                const G = (Math.floor(((6)*Z)*Math.random()+5))
                  const embed = new Discord.RichEmbed()
                  .setColor(3447003)
                  ...
                  .addField("Rapière basique à une main :" , +I)
                    ...
                    .addField("Épaulières en peau arrachées :" , +K)
                    .addField("Cape en peau arrachée :" , +L)
                    .addField("Plastron en peau arraché :" , +M)
                    .addField("Gantelets en peau arrachés :" , +N)
                    .addField("Ceinture en peau arrachée :" , +O)
                    .addField("Jambières en peau arrachées :" , +P)
                    .addField("Bottes en peau arrachées :" , +Q)
                  ...
                  .addField("Ragout de lapin :" , +V)
                        .addField("Points d'expérience :" , +F)
                  .addField("Si vous êtes du niveau de 8 ou plus :" , "Vous ne gagnez plus d'expérience sur ce monstre")
                  .addField("Cols :" , +G)
                  .setTimestamp()
                  message.channel.send({embed})
                      }
  ...
  const args = cont.slice(1);
                                                if (message.content.startsWith(prefix + "Bandit expérimenté récompenses")) {
                                                  let Z = args.slice(3).join(" : ");
                  const I = (Math.floor(((2*(0.95))*Z)*Math.random()))
                  const J = (Math.floor(((2*(0.97))*Z)*Math.random()))
                  const K = (Math.floor(((2*(0.97))*Z)*Math.random()))
                  const L = (Math.floor(((2*(0.97))*Z)*Math.random()))
                  const M = (Math.floor(((2*(0.97))*Z)*Math.random()))
                  const N = (Math.floor(((2*(0.97))*Z)*Math.random()))
                  const O = (Math.floor(((2*(0.97))*Z)*Math.random()))
                  const P = (Math.floor(((2*(0.97))*Z)*Math.random()))
                  const Q = (Math.floor(((2*(0.97))*Z)*Math.random()))
                     const R = (Math.floor(((2*(0.95))*Z)*Math.random()))
                    const S = (Math.floor(((2*(0.90))*Z)*Math.random()))
                     const T = (Math.floor(((2*(0.90))*Z)*Math.random()))
                      const U = (Math.floor(((2*(0.95))*Z)*Math.random()))
                      const V = (Math.floor(((2*(0.95))*Z)*Math.random()))
                  const F = (Math.floor(((14)*Z)*Math.random()+14))
                  const G = (Math.floor(((11)*Z)*Math.random()+10))
                    const embed = new Discord.RichEmbed()
                    .setColor(3447003)
                    ...
                    .addField("Épaulières en peau résistantes :" , +K)
                    .addField("Cape en peau résistante :" , +L)
                    .addField("Plastron en peau résistante :" , +M)
                    .addField("Gantelets en peau résistantes :" , +N)
                    .addField("Ceinture en peau résistante :" , +O)
                    .addField("Jambières en peau résistantes :" , +P)
                    .addField("Bottes en peau résistantes :" , +Q)
                  ...
                  .addField("Ragout de loup de sang :" , +V)
                             .addField("Points d'expérience :" , +F)
                    .addField("Si vous êtes du niveau de 13 ou plus :" , "Vous ne gagnez plus d'expérience sur ce monstre")
                    .addField("Cols :" , +G)
                    .setTimestamp()
                    message.channel.send({embed})
                        }
  ...
  const args = cont.slice(1);
                      ...
                      const I = (Math.floor(((2-(0.90))*AB)*Math.random()))
                  const J = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const K = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const L = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const M = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const N = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const O = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const P = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const Q = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const R = (Math.floor(((2*(0.95))*AB)*Math.random()))
                  const S = (Math.floor(((2*(0.95))*AB)*Math.random()))
                     const T = (Math.floor(((2*(0.95))*AB)*Math.random()))
                      const U = (Math.floor(((2*(0.90))*AB)*Math.random()))
                      const V = (Math.floor(((2*(0.90))*AB)*Math.random()))
                      const W = (Math.floor(((2*(0.90))*AB)*Math.random()))
                      const X = (Math.floor(((2*(0.90))*AB)*Math.random()))
                       const Y = (Math.floor(((2*(0.95))*AB)*Math.random()))
                        const Z = (Math.floor(((2*(0.95))*AB)*Math.random()))
                    const F = (Math.floor(((28)*AB)*Math.random()+28))
                    const G = (Math.floor(((21)*AB)*Math.random()+20))
                      const embed = new Discord.RichEmbed()
                      .setColor(3447003)
                      .setAuthor(message.author.username , message.author.avatarURL)
                      .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                  ...
                  .addField("Ragout de loup de sang :" , +X)
                       .addField("Points d'expérience :" , +F)
                       .addField("Si vous êtes du niveau de 20 ou plus :" , "Vous ne gagnez plus d'expérience sur ce monstre")
                      .addField("Cols :" , +G)
                      .setTimestamp()
                      message.channel.send({embed})
                          }
