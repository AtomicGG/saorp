...
bot.on('guildMemberAdd', member => {
  ...
  member.createDM().then(channel => {
    return channel.send("**__۝▬▬๑₪۩۞『『SAO Community ©』۞۩₪๑▬▬۝ __**\n\n\n『:white_check_mark:』Bienvenue à toi sur **『SAO Community [RP]』©** !\n\n\n『:white_check_mark:』Pour voir les salons de 『SAO Community [RP]』©, il faudra lire le réglement, puis appuyer sur la case verte où il est écrit [J'accepte le réglement !] pour avoir accès aux différents salons !『:white_check_mark:』N'oubliez pas aussi d'aller voir les salons #├──🎮ᴠᴏs-ᴊᴇᴜx ainsi que #├──📌ᴠᴏs-ɪɴғᴏʀᴍᴀᴛɪᴏɴs !\n\n\n『:white_check_mark:』Notre discord permettant de faire votre pub : https://discord.gg/NYH43Ks\n\n\n『:white_check_mark:』Notre discord principal évolue petit à petit, hésite pas à parler et faire venir tes amis, une partie d'animations ainsi que de rencontre sera mis en place !\n\n\n『:white_check_mark:』Que vous soyez un débutant ou un expert en RP, vous êtes les bienvenues, vous aurez toutes les informations nécessaire pour comprendre en écrivant sur le discord =Menu SAO 1\n\n\n**__۝▬▬๑₪۩۞『:ribbon:』۞۩₪๑▬▬۝__**")
  }).catch(console.error)
