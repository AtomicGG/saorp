...
bot.on('message', message => {
  if (message.content.startsWith(prefix + "Devenir partenaire")) {   
    ...
    .setAuthor(message.author.username , message.author.avatarURL)
    .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
.addField("Comment devenir partenaire ?" , "Pour pouvoir devenir partenaire avec notre discord, voici les critères :\n\n:one: Avoir au minimum  Pour pouvoir mettre votre RP dans la liste des RP, il n'y a pas de nombre minimum de membres à avoir, vous devrez remplir un formulaire disponible en écrivant :\n\n=Formulaire\n\nPour remplir ce formulaire, vous aurez besoin de mettre le thème et ce qui se trouve dans votre RP, vous avez la liste en écrivant :\n\n=Thème RP\n\nVous devez mettre au minimum 2 éléments, et maximum 10 éléments !\n\nUne fois le formulaire remplis, envoyez le au staff par messages privés !\n\nLa contrepartie sera que vous mettez notre pub RP sur votre discord avec la mention @everyone\n\nLa seul contrainte de ce partenariat est que vous ne devrez en aucun cas reprendre ou copier quelque chose propre à notre RP/discord !")    .setTimestamp()
    message.channel.send({embed})
        }
  }) ;
