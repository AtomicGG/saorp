...
bot.on('message', message => {
  ...
  const args = cont.slice(1);
                      ...
                      const I = (Math.floor(((2+(AB*1))*(0.90))*Math.random()))
                  const J = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const K = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const L = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const M = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const N = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const O = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const P = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const Q = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const R = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                  const S = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                     const T = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                      const U = (Math.floor(((2+(AB*1))*(0.90))*Math.random()))
                      const V = (Math.floor(((2+(AB*1))*(0.90))*Math.random()))
                      const W = (Math.floor(((2+(AB*1))*(0.90))*Math.random()))
                      const X = (Math.floor(((2+(AB*1))*(0.90))*Math.random()))
                       const Y = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
                        const Z = (Math.floor(((2+(AB*1))*(0.95))*Math.random()))
