...
bot.on('message', message => {
  ...
  const F = (Math.floor((14)*Math.random()+14))
    ...
    bot.on('message', message => {
      ...
      bot.on('message', message => {
        ...
        bot.on('message', message => {
          ...
          const E = (Math.floor((2-(0.85))*Math.random()))
          const I = (Math.floor((2-(0.90))*Math.random()))
          const F = (Math.floor((17)*Math.random()+17))
  ...
  const args = cont.slice(1);
    ...
    const embed = new Discord.RichEmbed()
     ...
     message.channel.send({embed})
                                              ...
                                              const B = (Math.floor((1+(Z))*Math.random()+0))
                                              const C = (Math.floor((1+(Z))*Math.random()+0))
                                              const D = (Math.floor((1+(Z))*Math.random()+0))
                                              const E = (Math.floor(((1+(Z))*(0.80))*Math.random()+0))
                                              const F = (Math.floor(((1+(Z))*(0.60))*Math.random()+0))
                                               const embed = new Discord.RichEmbed()
                                               .setAuthor(message.author.username , message.author.avatarURL)
                                               .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                               .setColor(3447003)
  ...
  const args = cont.slice(1);
    ...
    const embed = new Discord.RichEmbed()
     ...
     message.channel.send({embed})
                                                    ...
                                                    const C = (Math.floor((1+(Z))*Math.random()+0))
                                                    const D = (Math.floor((1+(Z))*Math.random()+0))
                                                    const E = (Math.floor(((1+(Z))*(0.60))*Math.random()+0))
                                                    const F = (Math.floor(((1+(Z))*(0.80))*Math.random()+0))
                                                     const embed = new Discord.RichEmbed()
                                                     .setAuthor(message.author.username , message.author.avatarURL)
                                                     .setFooter("『SAO Community [RP]』©", "http://www.copyrightfrance.com/images/copyright.png")
                                                     .setColor(3447003)
