...
bot.on('guildMemberAdd', member => {
  ...
  member.createDM().then(channel => {
    return channel.send("**__۝▬▬๑₪۩۞『『SAO Community ©』۞۩₪๑▬▬۝ __**\n\n\n『:white_check_mark:』Bienvenue à toi sur **『SAO Community [RP]』©** !\n\n\n『:white_check_mark:』Pour voir les salons de 『SAO Community [RP]』©, il faudra lire le réglement dans le salon├──📃ʀᴇ̀ɢʟᴇᴍᴇɴᴛ-a-lire, puis appuyer sur la case verte où il est écrit [J'accepte le réglement !] situé tout en haut, pour avoir accès aux différents salons de base !『:white_check_mark:』N'oubliez pas aussi d'aller voir les salons #├──🎮ᴠᴏs-ᴊᴇᴜx ainsi que #├──📌ᴠᴏs-ɪɴғᴏʀᴍᴀᴛɪᴏɴs et #├──📟ᴠᴏs-sᴀʟᴏɴs permettant d'obtenir les rôles que vous souhaitez avoir, ainsi que de pouvoir avoir accès aux parties du discord que vous souhaitez voir !\n\n\n『:link:』Notre discord permettant de faire votre pub : https://discord.gg/NYH43Ks\n\n\n『:white_check_mark:』Notre discord principal évolue petit à petit, hésite pas à parler et faire venir tes amis, il est en constante évolution selon vos avis c'est d'ailleurs pour cela que dans le salon #├──👑ɴᴏᴛᴇ-﹠ᴀᴠɪs vous pouvez noter le discord ainsi que donner votre avis !\n\n\n『:white_check_mark:』Que vous soyez un débutant ou un expert en RP, vous êtes les bienvenues, vous aurez toutes les informations nécessaire pour comprendre en écrivant sur le discord dans un salon de commande ceci : =Menu SAO 1\n\n\n**__۝▬▬๑₪۩۞『:ribbon:』۞۩₪๑▬▬۝__**")
  }).catch(console.error)
